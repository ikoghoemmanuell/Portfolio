        ...
        s.popupSelector
          ...
          : '<div class="' +
              ...
              (s.popupCloserSelector
                ...
                : "") +
              (s.popupNavPreviousSelector ? '<div class=""></div>' : "") +
              (s.popupNavNextSelector ? '<div class=""></div>' : "") +
              "</div>"
      );
      var v = x.find(".pic"),
        w = e(),
        ...
        x
          ...
          .on("poptrox_switch", function (o, t, p) {
            ...
            if (
              ...
              // Assuming you have an array of profile URLs corresponding to the images

              // Find the line where the click event is handled and modify it
              w.on("click", function (e) {
                e.preventDefault(); // Prevent the default click behavior
                var profileURLs = [
                  "https://github.com/ikoghoemmanuell/Prediction-with-ML-and-FastAPI",
                  "https://github.com/ikoghoemmanuell/Sentiment-Analysis-with-Finetuned-Models",
                  "https://github.com/ikoghoemmanuell/Deploying-a-ML-Model-with-Streamlit",
                  "https://github.com/ikoghoemmanuell/gradio-classification-app",
                  "https://github.com/ikoghoemmanuell/Classification----Predicting-Customer-Churn",
                  "https://github.com/ikoghoemmanuell/Time-Series-Forecasting-of-Store-Sales",
                  "https://github.com/ikoghoemmanuell/Indian-Startup-Funding-Analysis-Group-Nice",
                  "https://huggingface.co/ikoghoemmanuell",
                  // Add more profile URLs for each image
                ];
                var index = u.findIndex(function (item) {
                  return item.object.is(w);
                });
                var profileURL = profileURLs[index];
                if (profileURL) {
